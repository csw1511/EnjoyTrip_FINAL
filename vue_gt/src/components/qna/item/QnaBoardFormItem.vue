...
import { registQnaArticle, getModifyQnaArticle, modifyQnaArticle, deleteQnaArticle } from "@/api/qnaboard";
...
function writeArticle() {
  console.log("글등록하자qna!!", article.value);
  registQnaArticle(article.value,
    ({ data }) => {
      console.log(data);
    },
    (error) => {
...
function updateArticle() {
  ...
  // API 호출
  modifyQnaArticle(article.value,
    ({ data }) => {
      console.log(data);
    },
    (error) => {
