...
import { listQnaArticle } from "@/api/qnaboard";
...
const getQnaArticleList = () => {
  console.log("서버에서 QNA게시판 글목록 얻어오자!!!", param.value);
  listQnaArticle(
    param.value,
    ({ data }) => {
      console.log(data);
          ...
          <div class="col-md-5 offset-5">
            <form class="d-flex">
              ...
              <div class="input-group input-group-sm">
                ...
                <button class="btn btn-dark" type="button" @click="getQnaArticleList">검색</button>
              </div>
            </form>
          </div>
        </div>
