...
const writePlan = () => {
  ...
  if (isLogin) {
    ...
    router.push("/board/travelreviewboard/list");
  }
};
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <button type="button" class="btn btn-primary" data-bs-dismiss="modal" @click="writePlan">
              계획 작성하기
            </button>
          </div>
        </div>
...
table {
  ...
  /* Style for the "삭제" button */
  button {
    padding: 5px 10px;
    background-color: #28a745; /* Tomato color */
    color: white;
    border: none;
    border-radius: 4px;
    cursor: pointer;
